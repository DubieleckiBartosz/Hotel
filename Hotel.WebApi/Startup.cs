...
namespace Hotel.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.GetIdentityDependencyInjection();
            services.GetIdentityDb(Configuration);
            services.GetIdentityInfrastructure(Configuration);
            services.AddScoped<ErrorHandlingMiddleware>();
            services.GetSQLDatabase(Configuration);
            services.ApplicationDependency();
            services.InfrastructureDependency(Configuration);
